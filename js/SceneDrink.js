export default class SceneDrink extends Phaser.Scene {
    ...
    create() {
        ...
        this.cakeButton = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY-210, 'Cheese Cake Please!', { 
            fontSize: '20px', 
        ...
        this.cakeButton.once('pointerup', function (pointer) {
            ...
            this.time.delayedCall(2000, () => {
                ...
                // delay add return button
                this.time.delayedCall(500, () => {
                    this.returnButton = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY-210, 'Return', { 
                        fontSize: '20px', 
                        fontFamily: 'Helvetica', 
                        color: '#000000', 
                        backgroundColor: '#FEA99F', 
